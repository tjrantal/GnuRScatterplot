...
getXPlotLimits <- function(dataIn,digitsIn,tickMarks,xtraSpace) { #DEBUG dataIn =data[xVariable] digitsIn=xDesiredDigits[i] tickMarks=tickDivisions xtraSpace=xXtraSpace[i]
